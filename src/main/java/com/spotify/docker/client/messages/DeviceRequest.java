...
/**
 * A devices request to be sent to device drivers.
 */
@AutoValue
...
public abstract class DeviceRequest {
  ...
  public abstract static class Builder {
    ...
    public abstract DeviceRequest.Builder driver(String driver);

    public abstract DeviceRequest.Builder count(Integer count);

    public abstract DeviceRequest.Builder deviceIDs(List<String> deviceIDs);

    public abstract DeviceRequest.Builder capabilities(List<List<String>> capabilities);

    public abstract DeviceRequest.Builder options(Map<String, String> options);
